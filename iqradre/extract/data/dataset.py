...
class IDCardDataset(dataset.Dataset):
    def __init__(self, root, tokenizer, labels=None, 
                 mode='train',  excluce_image_mask=False,
        ...
        self.excluce_image_mask = excluce_image_mask
...
#         print(input_ids)
        ...
        if not self.excluce_image_mask:
            ...
            data = (input_ids, input_masks, segment_ids, label_ids, boxes)
...
class IDCardBaseDataset(dataset.Dataset):
    def __init__(self, root, tokenizer, labels=None, 
                 mode='train', excluce_image_mask=False,
                 test_size=0.2, max_seq_length=512, 
                 rand_seq=True, rand_seq_prob=0.5):
...
#         print(input_ids)
        ...
        if not self.excluce_image_mask:
            data = (
                input_ids, input_masks, 
                segment_ids, label_ids, boxes, img
            )
        else:
            data = (input_ids, input_masks, segment_ids, label_ids, boxes)
